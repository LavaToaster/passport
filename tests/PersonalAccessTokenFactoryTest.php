...
class PersonalAccessTokenFactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_access_token_can_be_created()
    {
        ...
        $factory = new LaravelDoctrine\Passport\PersonalAccessTokenFactory($server, $clients, $tokens, $jwt);
        ...
        $this->assertInstanceOf('LaravelDoctrine\Passport\PersonalAccessTokenResult', $result);
    }
}

...
class TransientTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('LaravelDoctrine\Passport\ApiTokenCookieFactory');
        ...
        $controller = new LaravelDoctrine\Passport\Http\Controllers\TransientTokenController($cookieFactory);

...
class AccessTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_a_token_can_be_issued()
    {
        ...
        $tokens = Mockery::mock(LaravelDoctrine\Passport\Repositories\TokenRepository::class);
        ...
        $controller = new LaravelDoctrine\Passport\Http\Controllers\AccessTokenController($server, $tokens, $jwt);
